# -*- coding: utf-8 -*-
#
# Mini Tutorial RegEx documentation build configuration file, created by
...
htmlhelp_basename = 'MiniTutorialRegExdoc'
...
epub_title = u'Mini Tutorial RegEx'
epub_author = u'Luciano Ramalho'
epub_publisher = u'Luciano Ramalho'
epub_copyright = u'2012, Luciano Ramalho'
